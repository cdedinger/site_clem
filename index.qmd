...
<div class="hero">
  <div class="hero-links-side">
    ...
    <a class="hero-pill" href="figs/CV_DEDINGER_2026.pdf"><i class="fa-solid fa-file-pdf" target="_blank"></i> CV (in French)</a>
    <a class="hero-pill" href="https://scholar.google.com/citations?user=8v3FwAsAAAAJ&hl=en" target="_blank"><i class="fa-solid fa-graduation-cap"></i> Scholar</a>
  </div>
